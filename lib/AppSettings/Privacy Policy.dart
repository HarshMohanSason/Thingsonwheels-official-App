...
import '../UserLogin/GoogleLogin/GoogleLoginAuth.dart';
...
class PrivacyPolicy extends StatelessWidget {
            ...
            child: AppBar(
              ...
              leading: InkWell(
                child: Icon(Icons.arrow_back,
                    size: screenWidth / 14,
                    color: Colors.white), // Ensure icon is readable
                onTap: () {
 ...
 This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You. We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Free Privacy Policy Generator. ''',
                      ...
                      _buildH1Heading("Interpretation and Definitions"),
                      _buildH3Heading('Interpretation'),
                      Text(
                      ...
                      _buildBulletPoint(
                          "Application refers to Thingsonwheels, the software program provided by the Company."),
                      _buildBulletPoint(
                          "Company (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to Thingsonwheels."),
                      _buildBulletPoint(
                      ...
                      _buildH2Heading("Types of Data Collected"),
                      _buildH3Heading("Personal Data"),
                      Text(
            ...
            We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.''',
                      ...
                      _buildH2Heading("Use of Your Personal Data"),
                      Text(
                      ...
                      _buildH2Heading("Retention of Your Personal Data"),
                      Text(
            ...
            The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods. ''',
                      ...
                      _buildH2Heading("Transfer of Your Personal Data"),
                      Text(
            ...
            The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information. ''',
                      ...
                      _buildH2Heading("Delete Your Personal Data"),
                      Text(
            ...
            Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so. ''',
                      ...
                      _buildH2Heading("Disclosure of Your Personal Data"),
                      _buildH3Heading("Business Transactions"),
                      Text(
                      ...
                      _buildH3Heading("Law enforcement"),
                      Text(
                      ...
                      _buildH3Heading("Other legal requirements"),
                      Text(
                      ...
                      _buildH2Heading("Security of Your Personal Data"),
                      Text(
                      ...
                      _buildH1Heading("Children's Privacy"),
                      Text(
            ...
            If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.''',
                      ...
                      _buildH1Heading("Links to Other Websites"),
                      Text(
            ...
            We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.''',
                      ...
                      _buildH1Heading("Changes to this Privacy Policy"),
                      Text(
            ...
            You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.''',
                      ...
                      _buildBulletPoint("By email: oggpoggp19962000@gmail.com"),
                      Text(
  ...
  Widget _buildH3Heading(String text) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          const Padding(
            ...
            // Adjust the top padding for the bullet
            child: Icon(Icons.brightness_1,
                size: 8.0), // Use a fixed size for the bullet icon
          ),
          const SizedBox(width: 8.0), // Add space between bullet and text
          Expanded(
            child: Text(
              text,
              style: TextStyle(
  ...
  Widget deleteAccountPopup(BuildContext context) {
    ...
    return AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          borderRadius:
              BorderRadius.circular(12), // Adjust the circular border radius
        ),
        content: SafeArea(
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Do you really want to delete your account? Note all your information will be deleted including all the merchant information as well',
